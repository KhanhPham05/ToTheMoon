...
public class ModRecipeProvider extends RecipeProvider implements RecipeGeneratorHelper {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        craftingShaped(ModItems.REDSTONE_MACHINE_FRAME, 1).pattern("RSR").pattern("S S").pattern("RSR").unlockedBy("collect_steel_or_redstone", InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().of(Items.REDSTONE, ModItems.STEEL_ROD).build())).define('R', Items.REDSTONE).define('S', ModItems.STEEL_ROD).save(consumer, ModUtils.modLoc("crafting_redstone_machine_frame"));
