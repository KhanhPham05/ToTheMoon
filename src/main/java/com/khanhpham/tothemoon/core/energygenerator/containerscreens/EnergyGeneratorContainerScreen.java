...
public class EnergyGeneratorContainerScreen extends AbstractEnergyGeneratorContainerScreen<EnergyGeneratorContainer> {
    public static final ResourceLocation GUI = new ResourceLocation("tothemoon:textures/gui/energy_generator_new.png");

    public EnergyGeneratorContainerScreen(EnergyGeneratorContainer pMenu, Inventory pPlayerInventory, Component pTitle) {
