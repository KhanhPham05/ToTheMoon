...
public class BatteryMenu extends BaseMenu {
    ...
    protected BatteryMenu(Container externalContainer, Inventory playerInventory, int pContainerId, ContainerData containerData) {
    ...
    public BatteryMenu(int id, Inventory playerInventory) {
        this(new SimpleContainer(2), playerInventory, id, new SimpleContainerData(2));
    }
