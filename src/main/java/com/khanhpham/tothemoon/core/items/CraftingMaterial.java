...
public class CraftingMaterial {
    ...
    public void generateRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        MetalPressRecipeBuilder.press(this.getPlateTag(), ModItemTags.ROD_MOLD, this.getRod(), 1).save(consumer, ModUtils.modLoc("metal_pressing/rod_" + this.plate.getId().getPath() + "_from_plate"));
