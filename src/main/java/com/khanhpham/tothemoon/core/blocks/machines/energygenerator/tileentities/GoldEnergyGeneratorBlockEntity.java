...
public class GoldEnergyGeneratorBlockEntity extends AbstractEnergyGeneratorBlockEntity {
    public GoldEnergyGeneratorBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntityTypes.GOLD_ENERGY_GENERATOR_TE.get(), pos, state, 500000, 550, new TranslatableComponent(ModBlocks.GOLD_ENERGY_GENERATOR.get().getDescriptionId()));
    }
}
