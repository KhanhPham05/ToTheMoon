...
record MekanismCompatProvider(Consumer<FinishedRecipe> consumer) {
    public void run() {
        ...
        MetallurgicInfusingBuilder.of(consumer, ModItems.REDSTONE_STEEL_MATERIAL.getIngot()).from(Ingredient.of(ModItemTags.INGOTS_STEEL), MetallurgicInfusingBuilder.InfuseType.REDSTONE, 30);
        MetallurgicInfusingBuilder.of(consumer, ModItems.REDSTONE_STEEL_MATERIAL.getDust()).from(Ingredient.of(ModItemTags.DUSTS_STEEL), MetallurgicInfusingBuilder.InfuseType.REDSTONE, 30);
    }
}