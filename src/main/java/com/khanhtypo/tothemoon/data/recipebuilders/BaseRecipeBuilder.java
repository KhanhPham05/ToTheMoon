...
public abstract class BaseRecipeBuilder implements RecipeBuilder {
    ...
    public void save(Consumer<FinishedRecipe> consumer, ResourceLocation recipeId) {
        //this.includeType(recipeId);
        consumer.accept(
                new RecipeFinisher(
                        this.getRecipeType(),
                        this::writeToJson,
                        recipeId,
                        this.trigger != null ? this.trigger : Advancement.Builder.recipeAdvancement().addCriterion("auto_trigger", PlayerTrigger.TriggerInstance.tick()),
                        recipeId,
                        this.result
                ));
