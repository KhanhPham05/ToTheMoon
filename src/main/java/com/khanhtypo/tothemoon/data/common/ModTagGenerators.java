...
public final class ModTagGenerators {
    ...
    public static void addProviders(boolean includeServer, DataGenerator dataGenerator, PackOutput packOutput, CompletableFuture<HolderLookup.Provider> lookup, ExistingFileHelper fileHelper) {
        ...
        final Blocks blocksProvider = dataGenerator.addProvider(includeServer, new Blocks(packOutput, lookup, ToTheMoon.MODID, fileHelper));
        final Item itemProvider = dataGenerator.addProvider(includeServer, new Item(packOutput, lookup, blocksProvider.contentsGetter(), ToTheMoon.MODID, fileHelper));
    }

    public static final class Blocks extends BlockTagsProvider {
        private final Set<? extends BlockObject<?>> modBlocks;

        Blocks(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider, String modId, @Nullable ExistingFileHelper existingFileHelper) {
        ...
        protected void addTags(HolderLookup.Provider p_256380_) {
            ...
            pickaxeMineable(METEORITE_LAMP, MOON_QUARTZ_ORE, MOON_ROCK_BARREL, PURIFIED_QUARTZ_BLOCK, SMOOTH_PURIFIED_QUARTZ_BLOCK, COPPER_POWER_GENERATOR, IRON_POWER_GENERATOR, GOLD_POWER_GENERATOR, DIAMOND_POWER_GENERATOR, NETHERITE_POWER_GENERATOR);
