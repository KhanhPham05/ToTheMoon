...
public final class ModTagGenerators {
    ...
    private static final class BlockGenerators extends BlockTagsProvider {
        ...
        protected void addTags(HolderLookup.Provider p_256380_) {
            ...
            pickaxeMineable(METEORITE_LAMP, MOON_QUARTZ_ORE, MOON_ROCK_BARREL, PURIFIED_QUARTZ_BLOCK, SMOOTH_PURIFIED_QUARTZ_BLOCK, COPPER_POWER_GENERATOR, IRON_POWER_GENERATOR, GOLD_POWER_GENERATOR, DIAMOND_POWER_GENERATOR, NETHERITE_POWER_GENERATOR, BLACK_STONE_FURNACE_CONTROLLER, BLACKSTONE_EMPTY_ACCEPTOR, NETHER_BRICKS_EMPTY_ACCEPTOR, BLACKSTONE_ITEM_ACCEPTOR, NETHER_BRICKS_ITEM_ACCEPTOR, STEEL_BATTERY, STANDARD_BATTERY, REDSTONE_BATTERY);
