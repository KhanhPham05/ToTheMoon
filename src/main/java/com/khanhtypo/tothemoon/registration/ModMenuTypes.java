...
public class ModMenuTypes {
    ...
    //public static final MenuObject<PowerGeneratorUpgradeSlotsMenu> POWER_GENERATOR_UPGRADES = new MenuObject<>("power_generator_upgrades", PowerGeneratorUpgradeSlotsMenu::new, PowerGeneratorUpgradesScreen::new);
