...
public abstract class SingleItemPowerBlockEntity extends AbstractPowerBlockEntity {
    ...
    public SingleItemPowerBlockEntity(BlockEntityObject<? extends AbstractPowerBlockEntity> blockEntity, BlockPos blockPos, BlockState blockState, PowerStorage energyStorage, Function<AbstractPowerBlockEntity, ContainerData> dataConstructor) {
